...
================================================== -->
	<?php if ( ! empty( $enable_top_bar ) ) { ?>
		<section id="top-bar-wrapper">
			<div id="top-bar" class="clearfix">
				<?php $enable_shopping_cart_on_woocommerce_pages_only = ot_get_option( 'enable_shopping_cart_on_woocommerce_pages_only' ); ?>
				<?php if ( ! empty( $enable_shopping_cart_on_woocommerce_pages_only ) ) { ?>
					...
					<?php } // End if ( is_woocommerce() || is_cart() || is_checkout() ) ?>
				<?php } // End if ( ! empty( $enable_shopping_cart_on_woocommerce_pages_only ) ) ?>
	...
	<?php $remove_header_height_reduction = ot_get_option( 'remove_header_height_reduction' ); ?>
	<section id="header-wrapper" <?php if ( $header_style == 'fixed' && empty( $enable_top_bar ) ) { ?>class="fixed"<?php } ?>>
		<section id="header" class="header" <?php if ( $header_style == 'fixed' ) { ?> <?php if ( empty( $remove_header_height_reduction ) && ! is_page_template( 'page-header-tansparent-2.php' ) ) { ?> data-99="height:112px;" data-100="height:74px;" data-smooth-scrolling="off"<?php } else { ?>class="header no-height-reduction"<?php } ?><?php } ?>>
				...
				<?php if ( $search_header_position == 'header' ) { ?>
					<div class="search-wrapper">
						<div class="search-form-wrapper">
							...
							<span id="remove-search" <?php if ( $header_style == 'fixed' ) { ?> <?php if ( empty( $remove_header_height_reduction ) ) { ?>data-99="padding:46px 0 46px;" data-100="padding:27px 0px 27px;" data-smooth-scrolling="off"<?php } ?><?php } ?>>&times;</span>
						</div>
					</div>
				<?php } ?>
	...
	================================================== -->
				...
				<?php } ?>
					...
					<?php if ( ! empty( $logo ) ) { ?>
						...
						<div class="site-title-custom clearfix" <?php if ( $header_style == 'fixed' ) { ?><?php if ( empty( $remove_header_height_reduction ) && ! is_page_template( 'page-header-tansparent-2.php' ) ) { ?>data-99="margin:31px 0px;" data-100="margin:12px 0px;" data-smooth-scrolling="off"<?php } ?><?php } ?>>
							<a href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home" id="custom-logo">
								...
								<?php if ( ! empty( $logo_light ) ) { ?>
									...
									<img class="logo-light" src="<?php echo esc_url( $src_light[0] ); ?>" width="<?php echo esc_attr( $src_light[1] ); ?>" height="<?php echo esc_attr( $src_light[2] ); ?>" />
								<?php } ?>
								
								<?php if ( ! empty( $logo_retina ) ) : ?>
									<img class="logo-retina" src="<?php echo esc_url( $src_retina[0] ); ?>" width="<?php echo esc_attr( $src_retina[1] ); ?>" height="<?php echo esc_attr( $src_retina[2] ); ?>" />
								<?php endif; ?>
								
								<?php if ( ! empty( $logo_retina_light ) ) : ?>
									<img class="logo-retina-light" src="<?php echo esc_url( $src_retina_light[0] ); ?>" width="<?php echo esc_attr( $src_retina_light[1] ); ?>" height="<?php echo esc_attr( $src_retina_light[2] ); ?>" />
								<?php endif; ?>
					...
					<?php } else { ?>
						<div id="site-title" class="clearfix" <?php if ( $header_style == 'fixed' ) { ?><?php if ( empty( $remove_header_height_reduction ) ) { ?>data-99="margin:45px 0px;" data-100="margin:25px 0px;" data-smooth-scrolling="off"<?php } ?><?php } ?>>
	...
	================================================== -->
				...
				<?php } ?>
							...
							<?php if ( $search_header_position == 'header' ) { ?>
								<div class="search-wrapper">
									<div class="search-form-wrapper">
										...
										<span id="remove-search" <?php if ( $header_style == 'fixed' ) { ?> <?php if ( empty( $remove_header_height_reduction ) ) { ?>data-99="padding:46px 0 46px;" data-100="padding:46px 0px 46px;" data-smooth-scrolling="off"<?php } ?><?php } ?>>&times;</span>
									</div>
								</div>
							<?php } ?>
						...
						<?php $search_header_position = ot_get_option( 'search_header_position' ); ?>
						<?php if ( $search_header_position == 'header' ) { ?>	
							<div class="search-header-wrapper" <?php if ( $header_style == 'fixed' ) { ?><?php if ( empty( $remove_header_height_reduction ) ) { ?>data-99="margin:48px 0 48px" data-100="margin:29px 0px 29px;" data-smooth-scrolling="off"<?php } ?><?php } ?>>
								<a id="search-header-icon" href="#">
									<i></i>
								</a>
							</div>
						...
						<?php if ( $social_icons_position == 'header' ) { ?>
							<div class="social-accounts-wrapper" <?php if ( $header_style == 'fixed' ) { ?><?php if ( empty( $remove_header_height_reduction ) ) { ?>data-99="margin:48px 0 48px" data-100="margin:29px 0px 29px;" data-smooth-scrolling="off"<?php } ?><?php } ?>>
								<?php get_template_part( 'social-accounts' ); // Social accounts ?>
							</div>
						<?php } ?>
						...
						<?php } // End if ( is_woocommerce() || is_cart() || is_checkout() ) ?>
						<?php } // End if ( function_exists ( "is_woocommerce" ) ) ?>
						<?php } // End if ( ! empty( $enable_shopping_cart_on_woocommerce_pages_only ) ) ?>
						...
						<?php if ( ! empty( $header_info ) ) { ?>
							<div class="info-header" <?php if ( $header_style == 'fixed' ) { ?> <?php if ( empty( $remove_header_height_reduction ) ) { ?>data-99="margin:48px 0 48px;" data-100="margin:29px 0px 29px;" data-smooth-scrolling="off"<?php } ?><?php } ?>>
									<?php if ( function_exists( 'icl_t' ) ) { ?>
						...
						<?php } // End if ( empty( $enable_full_width_menu ) ) ?>
						
						<?php if ( has_nav_menu( 'primary' ) ) { ?>
							<a id="mobile-menu-dropdown" class="clearfix" href="#">
								<i></i> <?php _e( 'Menu', 'mega' ); ?>
							</a>
					<?php } ?>
					</nav><!-- #access -->
			</header><!-- #branding -->		
