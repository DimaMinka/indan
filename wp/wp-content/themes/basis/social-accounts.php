...
<?php endif; // end if ?>
	...
	?>
		<a class="social google" href="<?php echo esc_url( $gplus_url ); ?>" target="_blank" rel="nofollow">
			<span class="social-icon"></span>
		</a>
	<?php endif; // end if ?>
	...
	?>
		<a class="social px" href="<?php echo esc_url( $px_url ); ?>" target="_blank" rel="nofollow">
			<span class="social-icon"></span>
		</a>
	<?php endif; // end if ?>
	...
	?>
		<a class="social vk" href="<?php echo esc_url( $vk_url ); ?>" target="_blank" rel="nofollow">
			<span class="social-icon"></span>
		</a>
	<?php endif; // end if ?>
