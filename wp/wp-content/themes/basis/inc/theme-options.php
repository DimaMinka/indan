  ...
  $custom_settings = array( 
    ...
    'settings'        => array( 
      ...
      array(
        ...
        'desc'        => __( 'Choose a primary color for your site. Default value is #f39c12.', 'mega' ),
        'std'         => '#f39c12',
        'type'        => 'colorpicker',
        'section'     => 'general',
        'rows'        => '',
      ...
      array(
        ...
        'desc'        => __( 'Choose a color for heading for your site. Default value is #444444.', 'mega' ),
        'std'         => '#444444',
        'type'        => 'colorpicker',
        'section'     => 'general',
        'rows'        => '',
      ...
      array(
        ...
        'label'       => __( 'Use Page Load Progress Bar', 'mega' ),
        'desc'        => __( 'Use page load progress bar?', 'mega' ),
        'std'         => '',
        'type'        => 'checkbox',
        'section'     => 'general',
        'rows'        => '',
      ...
      array(
        ...
        'desc'        => __( '<p class="warning">Paste Google Web Font link to your website.</p><p><b>Read more:</b> <a href="http://www.google.com/webfonts" target="_blank"><code>http://www.google.com/webfonts</code></a></p> </b><p><b>Example:</b> <code>http://fonts.googleapis.com/css?family=Ubuntu:300,400,700</code></p>', 'mega' ),
        'std'         => 'http://fonts.googleapis.com/css?family=Ubuntu:300,400,700',
        'type'        => 'text',
        'section'     => 'typography',
        'rows'        => '',
        'post_type'   => '',
...
<p><b>Example:</b> <code>Ubuntu</code></p>', 'mega' ),
        'std'         => 'Ubuntu',
        'type'        => 'text',
        'section'     => 'typography',
        'rows'        => '',
      ...
      array(
        ...
        'desc'        => __( '<p class="warning">Paste Google Web Font link for menu to your website.</p><p><b>Read more:</b> <a href="http://www.google.com/webfonts" target="_blank"><code>http://www.google.com/webfonts</code></a></p> </b><p><b>Example:</b> <code>http://fonts.googleapis.com/css?family=Ubuntu:300,400,700</code></p>', 'mega' ),
        'std'         => '',
        'type'        => 'text',
        'section'     => 'typography',
        'rows'        => '',
...
<p><b>Example:</b> <code>Montserrat</code></p>', 'mega' ),
        'std'         => 'Montserrat',
        'type'        => 'text',
        'section'     => 'typography',
        'rows'        => '',
      ...
      array(
        ...
        'desc'        => __( 'Choose a value for menu font size in pixels. Default value is 16.', 'mega' ),
        'std'         => '16',
        'type'        => 'numeric-slider',
        'section'     => 'typography',
        'rows'        => '',
      ...
      array(
        ...
        'desc'        => __( '<p class="warning">Paste Google Web Font link for headings to your website.</p><p><b>Read more:</b> <a href="http://www.google.com/webfonts" target="_blank"><code>http://www.google.com/webfonts</code></a></p> </b><p><b>Example:</b> <code>http://fonts.googleapis.com/css?family=Montserrat:400,700</code></p>', 'mega' ),
        'std'         => 'http://fonts.googleapis.com/css?family=Montserrat:400,700',
        'type'        => 'text',
        'section'     => 'typography',
        'rows'        => '',
        'post_type'   => '',
      ...
      array(
        ...
        'desc'        => __( '<p>Enter the Google Web Font name for header typography.</p>
<p><b>Example:</b> <code>Montserrat</code></p>', 'mega' ),
        'std'         => 'Montserrat',
        'type'        => 'text',
        'section'     => 'typography',
      ...
      array(
        'id'          => 'enable_full_width_menu',
        'label'       => __( 'Enable Full Width Menu?', 'mega' ),
        'desc'        => __( 'Enable Full Width Menu?', 'mega' ),
        'std'         => '',
        'type'        => 'checkbox',
        'section'     => 'header',
        'rows'        => '',
      ...
      array(
        ...
        'label'       => __( 'Search Icon, Social Icons and  Header Info Margin for Header', 'mega' ),
        'desc'        => __( 'Choose a value for search icon, social icons and header info margin for header in pixels. Default margin is 48.', 'mega' ),
        'std'         => '48',
        'type'        => 'numeric-slider',
        'section'     => 'header',
        'rows'        => '',
      ...
      array(
        ...
        'desc'        => __( 'Choose a value for logo margin in pixels. Default width is 46.', 'mega' ),
        'std'         => '46',
        'type'        => 'numeric-slider',
        'section'     => 'header',
        'rows'        => '',
      ...
      array(
        ...
        'desc'        => __( 'Choose a value for navigation link color. Default value is #444444.', 'mega' ),
        'std'         => '#444444',
        'type'        => 'colorpicker',
        'section'     => 'header',
        'rows'        => '',
      ...
      array(
        ...
        'desc'        => __( 'Choose a value for navigation link color - hover/active. Default value is #444444.', 'mega' ),
        'std'         => '#444444',
        'type'        => 'colorpicker',
        'section'     => 'header',
        'rows'        => '',
      ...
      array(
        ...
        'desc'        => __( 'Choose a value for header text color. Default value is #444444.', 'mega' ),
        'std'         => '#444444',
        'type'        => 'colorpicker',
        'section'     => 'header',
        'rows'        => '',
      ...
      array(
        ...
        'label'       => __( 'Header Link Color - Hover/Active', 'mega' ),
        'desc'        => __( 'Choose a value for header link color - hover/active. Default value is #444444.', 'mega' ),
        'std'         => '#444444',
        'type'        => 'colorpicker',
        'section'     => 'header',
        'rows'        => '',
      ...
      array(
        ...
        'desc'        => __( 'Choose a value for top bar background color. Default value is #444444.', 'mega' ),
        'std'         => '#444444',
        'type'        => 'colorpicker',
        'section'     => 'header',
        'rows'        => '',
      ...
      array(
        ...
        'desc'        => __( 'Choose a value for top bar text color. Default value is #ffffff.', 'mega' ),
        'std'         => '#ffffff',
        'type'        => 'colorpicker',
        'section'     => 'header',
        'rows'        => '',
      ...
      array(
        ...
        'desc'        => __( 'Choose a value for top bar link color. Default value is #f39c12.', 'mega' ),
        'std'         => '#f39c12',
        'type'        => 'colorpicker',
        'section'     => 'header',
        'rows'        => '',
      ...
      array(
        ...
        'desc'        => __( 'Choose a value for top bar link color - hover/active. Default value is #ffffff.', 'mega' ),
        'std'         => '#ffffff',
        'type'        => 'colorpicker',
        'section'     => 'header',
        'rows'        => '',
      ...
      array(
        ...
        'desc'        => __( 'Choose a value for social icons color. Default value is #ffffff.', 'mega' ),
        'std'         => '#ffffff',
        'type'        => 'colorpicker',
        'section'     => 'header',
        'rows'        => '',
      ...
      array(
        ...
        'std'         => '© Basis Construction Business WordPress Theme',
        'type'        => 'textarea',
        'section'     => 'footer',
        'rows'        => '',
        'post_type'   => '',
      ...
      array(
        'id'          => 'footer_info_and_footer_social_icons_level',
        'label'       => __( 'Footer Info and Footer Social Icons Level', 'mega' ),
        'desc'        => __( 'Choose a footer info and footer social icons level.', 'mega' ),
        'std'         => '',
        'type'        => 'select',
        'section'     => 'footer',
        'rows'        => '',
        ...
        'choices'     => array( 
          array(
            'value'       => 'different_levels',
            'label'       => __( 'Different levels', 'mega' ),
            'src'         => ''
          ),
          array(
            'value'       => 'single_level',
            'label'       => __( 'Single level', 'mega' ),
            'src'         => ''
          )
        )
      ),
      ...
      array(
        ...
        'desc'        => __( 'Choose a value for back to top button color. Default value is #ffffff.', 'mega' ),
        'std'         => '#ffffff',
        'type'        => 'colorpicker',
        'section'     => 'footer',
        'rows'        => '',
      ...
      array(
        ...
        'desc'        => __( 'Choose a value for back to top button color - hover/active. Default value is #f39c12.', 'mega' ),
        'std'         => '#f39c12',
        'type'        => 'colorpicker',
        'section'     => 'footer',
        'rows'        => '',
      ...
      array(
        ...
        'desc'        => __( 'Choose a value for footer background color. Default value is #444444.', 'mega' ),
        'std'         => '#444444',
        'type'        => 'colorpicker',
        'section'     => 'footer',
        'rows'        => '',
      ...
      array(
        ...
        'desc'        => __( 'Choose a value for footer top border color. Default value is #444444.', 'mega' ),
        'std'         => '#444444',
        'type'        => 'colorpicker',
        'section'     => 'footer',
        'rows'        => '',
      ...
      array(
        ...
        'desc'        => __( 'Choose a value for footer widget title color in pixels. Default value is #ffffff.', 'mega' ),
        'std'         => '#ffffff',
        'type'        => 'colorpicker',
        'section'     => 'footer',
        'rows'        => '',
      ...
      array(
        ...
        'desc'        => __( 'Choose a value for footer text color. Default value is #ffffff.', 'mega' ),
        'std'         => '#ffffff',
        'type'        => 'colorpicker',
        'section'     => 'footer',
        'rows'        => '',
      ...
      array(
        ...
        'desc'        => __( 'Choose a value for footer link color. Default value is #ffffff.', 'mega' ),
        'std'         => '#ffffff',
        'type'        => 'colorpicker',
        'section'     => 'footer',
        'rows'        => '',
      ...
      array(
        ...
        'desc'        => __( 'Choose a value for footer link color - hover/active. Default value is #f39c12.', 'mega' ),
        'std'         => '#f39c12',
        'type'        => 'colorpicker',
        'section'     => 'footer',
        'rows'        => '',
      ...
      array(
        ...
        'desc'        => __( 'Choose a value for border between footer and footer bottom area color. Default value is #222222.', 'mega' ),
        'std'         => '#222222',
        'type'        => 'colorpicker',
        'section'     => 'footer',
        'rows'        => '',
      ...
      array(
        ...
        'desc'        => __( 'Choose a value for footer bottom area background color. Default value is #222222.', 'mega' ),
        'std'         => '#222222',
        'type'        => 'colorpicker',
        'section'     => 'footer',
        'rows'        => '',
      ...
      array(
        ...
        'desc'        => __( 'Choose a value for footer bottom area link color. Default value is #cccccc.', 'mega' ),
        'std'         => '#cccccc',
        'type'        => 'colorpicker',
        'section'     => 'footer',
        'rows'        => '',
      ...
      array(
        ...
        'desc'        => __( 'Choose a value for footer bottom area link color - hover/active. Default value is #f39c12.', 'mega' ),
        'std'         => '#f39c12',
        'type'        => 'colorpicker',
        'section'     => 'footer',
        'rows'        => '',
      ...
      array(
        ...
        'desc'        => __( 'Choose a value for footer bottom area text color. Default value is #cccccc.', 'mega' ),
        'std'         => '#cccccc',
        'type'        => 'colorpicker',
        'section'     => 'footer',
        'rows'        => '',
      ...
      array(
        'id'          => 'blog_heading',
        'label'       => __( 'Blog Heading', 'mega' ),
        'desc'        => __( 'Enable or disable blog heading?', 'mega' ),
        'std'         => '',
        'type'        => 'select',
      ...
      array(
        'id'          => 'portfolio_page',
        'label'       => __( 'Portfolio Page', 'mega' ),
        'desc'        => __( 'Select the portfolio page. Used for the "Back to the Projects" link.', 'mega' ),
        'std'         => '',
        'type'        => 'page-select',
      ...
      array(
        'id'          => 'px_url',
        'label'       => __( '500px Address (URL)', 'mega' ),
        'desc'        => '',
        'std'         => 'https://500px.com/',
        'type'        => 'text',
        'section'     => 'social',
      ...
      array(
        'id'          => 'enable_shopping_cart_on_woocommerce_pages_only',
        'label'       => __( 'Enable Shopping Cart on WooCommerce Pages Only?', 'mega' ),
        'desc'        => __( 'Enable shopping cart on WooCommerce pages only?', 'mega' ),
        'std'         => '',
        'type'        => 'checkbox',
        'section'     => 'woocommerce',
        'rows'        => '',
