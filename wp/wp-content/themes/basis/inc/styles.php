...
function mega_enqueue_header_google_fonts() {
	...
	if ( ! empty( $header_google_font_family ) ) {
		echo '<link href="'. esc_url( $header_google_font_family ) .'" rel="stylesheet" type="text/css">';
	}
}
...
function mega_print_primary_color_style() {
	...
	if ( empty( $primary_color ) || $primary_color == '#f39c12' )
		return;
	
	$rgb_primary_color = mega_hex2rgb( $primary_color );
	$rgba_primary_color = "rgba(" . $rgb_primary_color[0] . ", " . $rgb_primary_color[1] . ", " . $rgb_primary_color[2] . ", .4)";
?>
	<style>
		/* Primary color */
		#top-bar a,
		...
		#site-generator a:hover {
			border-color: <?php echo esc_attr( $rgba_primary_color ); ?>;
		}
...
function mega_print_navigation_link_color_style() {
	...
	if ( empty( $navigation_link_color ) || $navigation_link_color == '#444444' )
		return;
?>
	<style>
...
function mega_print_navigation_link_color_hover_style() {
	...
	if ( empty( $navigation_link_color_hover ) || $navigation_link_color_hover == '#444444' )
		return;
?>
	<style>
		...
		#access ul .current-menu-item > a,
		#access ul .current_page_item > a {
			color: <?php echo esc_attr( $navigation_link_color_hover ); ?>;
		}
	</style>
<?php
}
...
function mega_print_header_text_color_style() {
	...
	if ( empty( $header_text_color ) || $header_text_color == '#444444' )
		return;
?>
	<style>
		/* Header Text Color */
...
function mega_print_header_link_color_hover_style() {
	...
	if ( empty( $header_link_color_hover ) || $header_link_color_hover == '#444444' )
		return;
	
	$rgb_header_link_color_hover = mega_hex2rgb( $header_link_color_hover );
	$rgba_header_link_color_hover = "rgba(" . $rgb_header_link_color_hover[0] . ", " . $rgb_header_link_color_hover[1] . ", " . $rgb_header_link_color_hover[2] . ", .4)";
?>
	<style>
		/* Header Link Color - Hover/Active */
		#access .info-header a:hover {
			color: <?php echo esc_attr( $header_link_color_hover ); ?>;
			border-color: <?php echo esc_attr( $rgba_header_link_color_hover ); ?>;
		}
	</style>
<?php
}
add_action( 'wp_head', 'mega_print_header_link_color_hover_style' );
...
/**
 * Add a style block to the theme for the search icon, social icons and header info margin.
 */
function mega_print_search_icon_margin_style() {
	$search_icon_margin = ot_get_option( 'search_icon_margin' );
	
	// Don't do anything if the search icon, social icons and header info are the default.
	if ( $search_icon_margin == 48 )
		return;
?>
	<style>
...
function mega_print_top_bar_background_color_style() {
	...
	if ( empty( $top_bar_background_color ) || $top_bar_background_color == '#444444' )
		return;
?>
	<style>
...
function mega_print_top_bar_link_color_style() {
	...
	if ( empty( $top_bar_link_color ) || $top_bar_link_color == '#f39c12' )
		return;
	
	$rgb_top_bar_link_color = mega_hex2rgb( $top_bar_link_color );
	$rgba_top_bar_link_color = "rgba(" . $rgb_top_bar_link_color[0] . ", " . $rgb_top_bar_link_color[1] . ", " . $rgb_top_bar_link_color[2] . ", .4)";
?>
	<style>
		/* Top Bar Link Color */
		#top-bar #lang_sel a,
		...
		#top-bar a,
		#top-bar .info-header a {
			border-color: <?php echo esc_attr( $rgba_top_bar_link_color ); ?>;
		}
	</style>
<?php
}
...
function mega_print_top_bar_link_color_hover_style() {
	...
	$rgb_top_bar_link_color_hover = mega_hex2rgb( $top_bar_link_color_hover );
	$rgba_top_bar_link_color_hover = "rgba(" . $rgb_top_bar_link_color_hover[0] . ", " . $rgb_top_bar_link_color_hover[1] . ", " . $rgb_top_bar_link_color_hover[2] . ", .4)";
?>
	<style>
		...
		#top-bar a:hover,
		#top-bar .info-header a:hover {
			border-color: <?php echo esc_attr( $rgba_top_bar_link_color_hover ); ?> !important;
		}
	</style>
<?php
}
...
function mega_print_top_bar_social_icons_color_style() {
	...
	if ( empty( $top_bar_social_icons_color ) || $top_bar_social_icons_color == '#ffffff' )
		return;
?>
	<style>
		/* Social Icons color */
...
function mega_print_footer_background_color_style() {
	...
	if ( empty( $footer_background_color ) || $footer_background_color == '#444444' )
		return;
?>
	<style>
...
function mega_print_back_to_top_button_color_style() {
	...
	if ( empty( $back_to_top_button_color ) || $back_to_top_button_color == '#ffffff' )
		return;
?>
	<style>
		/* Back To Top Button Color */
		#site-generator #to-top div {
			border-color: <?php echo esc_attr( $back_to_top_button_color ); ?>;
		}
	</style>
<?php
}
...
function mega_print_back_to_top_button_color_hover_style() {
	...
	if ( empty( $back_to_top_button_color_hover ) || $back_to_top_button_color_hover == '#f39c12' )
		return;
?>
	<style>
		/* Back To Top Button Color - Hover/Active */
		#site-generator #to-top:hover div{
			border-color: <?php echo esc_attr( $back_to_top_button_color_hover ); ?>;
		}
	</style>
<?php
}
...
function mega_print_footer_top_border_color_style() {
	...
	if ( empty( $footer_top_border_color ) || $footer_top_border_color == '#444444' )
		return;
?>
	<style>
...
function mega_print_footer_widget_title_color_style() {
	...
	if ( empty( $footer_widget_title_color ) || $footer_widget_title_color == '#ffffff' )
		return;
?>
	<style>
...
function mega_print_footer_text_color_style() {
	...
	if ( empty($footer_text_color) || $footer_text_color == '#ffffff' )
		return;
?>
	<style>
		/* Footer Text Color */
...
function mega_print_footer_link_color_style() {
	...
	if ( empty($footer_link_color) || $footer_link_color == '#ffffff' )
		return;
	
	$rgb_footer_link_color = mega_hex2rgb( $footer_link_color );
	$rgba_footer_link_color = "rgba(" . $rgb_footer_link_color[0] . ", " . $rgb_footer_link_color[1] . ", " . $rgb_footer_link_color[2] . ", .4)";
?>
	<style>
		/* Footer Link Color */
		...
		#supplementary .widget a {
			border-color: <?php echo esc_attr( $rgba_footer_link_color ); ?>;
		}
	</style>
<?php
}
...
function mega_print_footer_link_color_hover_style() {
	...
	if ( empty($footer_link_color_hover) || $footer_link_color_hover == '#f39c12' )
		return;
	
	$rgb_footer_link_color_hover = mega_hex2rgb( $footer_link_color_hover );
	$rgba_footer_link_color_hover = "rgba(" . $rgb_footer_link_color_hover[0] . ", " . $rgb_footer_link_color_hover[1] . ", " . $rgb_footer_link_color_hover[2] . ", .4)";
?>
	<style>
		...
		#supplementary .widget a:hover {
			border-color: <?php echo esc_attr( $rgba_footer_link_color_hover ); ?>;
		}
	</style>
<?php
}
...
function mega_print_border_between_footer_and_footer_bottom_area_color_style() {
	...
	if ( empty( $border_between_footer_and_footer_bottom_area_color ) || $border_between_footer_and_footer_bottom_area_color == '#222222' )
		return;
?>
	<style>
...
function mega_print_footer_bottom_area_background_color_style() {
	...
	if ( empty( $footer_bottom_area_background_color ) || $footer_bottom_area_background_color == '#222222' )
		return;
?>
	<style>
...
function mega_print_footer_bottom_area_link_color_style() {
	...
	if ( empty($footer_bottom_area_link_color) || $footer_bottom_area_link_color == '#cccccc' )
		return;
	
	$rgb_footer_bottom_area_link_color = mega_hex2rgb( $footer_bottom_area_link_color );
	$rgba_footer_bottom_area_link_color = "rgba(" . $rgb_footer_bottom_area_link_color[0] . ", " . $rgb_footer_bottom_area_link_color[1] . ", " . $rgb_footer_bottom_area_link_color[2] . ", .4)";
?>
	<style>
		/* Footer Bottom Area Link Color */
		#site-generator a {
			color: <?php echo esc_attr( $footer_bottom_area_link_color ); ?>;
			border-color: <?php echo esc_attr( $rgba_footer_bottom_area_link_color ); ?>;
		}
	</style>
<?php
}
...
function mega_print_footer_bottom_area_link_color_hover_style() {
	...
	if ( empty($footer_bottom_area_link_color_hover) || $footer_bottom_area_link_color_hover == '#f39c12' )
		return;
	
	$rgb_footer_bottom_area_link_color_hover = mega_hex2rgb( $footer_bottom_area_link_color_hover );
	$rgba_footer_bottom_area_link_color_hover = "rgba(" . $rgb_footer_bottom_area_link_color_hover[0] . ", " . $rgb_footer_bottom_area_link_color_hover[1] . ", " . $rgb_footer_bottom_area_link_color_hover[2] . ", .4)";
?>
	<style>
		...
		#site-generator a:hover {
			border-color: <?php echo esc_attr( $rgba_footer_bottom_area_link_color_hover ); ?>;
		}
	</style>
<?php
}
...
function mega_print_footer_bottom_area_text_color_style() {
	...
	if ( empty($footer_bottom_area_text_color) || $footer_bottom_area_text_color == '#cccccc' )
		return;
?>
	<style>
...
/**
 * Add a style block to the theme for the footer info and footer social icons level.
 */
function mega_print_footer_info_and_footer_social_icons_level_style() {
	$footer_info_and_footer_social_icons_level = ot_get_option( 'footer_info_and_footer_social_icons_level' );
	
	// Don't do anything if the footer info and footer social icons level.
	if ( $footer_info_and_footer_social_icons_level == 'different_levels' )
		return;
?>
	<style>
...
add_action( 'wp_head', 'mega_print_footer_info_and_footer_social_icons_level_style' );